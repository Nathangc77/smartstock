package com.moreira.smartstock.controllers.handlers;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> violationDatabase(DatabaseException e, HttpServletRequest request) {
    ...
    public ResponseEntity<CustomError> fieldError(MethodArgumentNotValidException e, HttpServletRequest request) {
